...
export default function Home() {
  ...
  return (
    <div className="container">
      ...
      Tilekit is the underlying personal software framework that powers the <a href="https://tiles.run/" className="builder-link">tiles.run</a> notebook interface. Github: <a href="https://github.com/Agent54/tilekit" className="builder-link">Agent54/tilekit</a>
