...
const Home: NextPage = () => {
  ...
  return (
    <div className="container">
      ...
      Tilekit is the underlying personal software framework that powers the <a href="https://tiles.run/" className="builder-link">tiles.run</a> notebook interface. Github: <a href="https://github.com/feynon/tilekit/tree/dev/packages/wasm-runner" className="builder-link">feynon/tilekit</a>
